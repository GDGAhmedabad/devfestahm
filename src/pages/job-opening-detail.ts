...
export class JobOpeningDetailPage extends ReduxMixin(PolymerElement) {
      ...
      <div class="job-openings-container">
        <div class="" layout horizontal>
          <div class="member-details" layout vertical center-justified start>
            ...
            <template is="dom-if" if="[[companyDetails.hiringImageUrl]]">
              <img class="hiring-image" src="[[companyDetails.hiringImageUrl]]" alt="hiring image"></img>
            </template>
          </div>
        </div>
      </div>
